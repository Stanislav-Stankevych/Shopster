...
- Initial public release of Shopster demo.
- Django 5 + DRF backend with catalog, orders, accounts, blog and Algolia search.
- Next.js 15 storefront with catalog filters, checkout, account pages and blog.
